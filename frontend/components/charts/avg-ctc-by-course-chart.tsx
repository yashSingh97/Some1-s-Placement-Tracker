...
import { useAvgCtcByCourse } from '@/hooks/useAnalyticsData'
...
export function AvgCtcByCourseChart() {
  const { data, loading, error } = useAvgCtcByCourse()

  const chartData = useMemo(() => {
    return data.sort((a, b) => b.avg_ctc - a.avg_ctc)
  }, [data])
